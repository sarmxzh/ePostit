$componentPagePadding: 50px;
$componentPageDividingMargin: 40px;
$componentSubHeadMargin: 24px;
$dosColor: #177D3E;
$dontColor: #A61E22;
...
.ComponentPage {
  @include fullWidth(); // Component page has its own padding
  // @include fullHeight(); // Remove padding at bottom of App-content
  // padding-bottom: 100px; // Pad the content instead
}
...
.ComponentPage-title {
  ...
  width: 100%;
  margin-top: $componentPagePadding;
  margin-bottom: $componentPagePadding;
}
...
.ComponentPage-overview {
  ...
  margin-bottom: -6px; // Trim padding off last paragraph
...
.ComponentPage-doSection {
  ...
  &:first-child {
    @include margin-right(116px);  // @TODO: Needs to match fabric react site (120px)
  }
}
...
.ComponentPage-methodsSection,
.ComponentPage-implementationSection {
  @include contentPadding(50px, 50px);  // Override padding to match this website
}
